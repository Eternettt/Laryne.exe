/* ==========================================================================
   ...
   - PUT /api/admin/orders  { id }            → réécrit vers
       /api/orders?mode=admin (admin uniquement) : marque la commande comme
       expédiée (shipped_at = now()) — elle disparaît alors de la liste
       ci-dessus.
   ========================================================================== */
...
async function handleAdmin(req, res) {
  ...
  // apparaissent ici : une fois validée (voir handleMarkShipped), une
...
module.exports = async (req, res) => {
  ...
  try {
    if (req.method === 'PUT') {
      // Seule la file d'attente admin peut être modifiée (marquer expédié).
