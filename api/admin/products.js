...
// ---- Revérifie le rôle admin EN BASE à chaque appel (jamais depuis le
// seul cookie), pour empêcher un cookie trafiqué de mentir sur le rôle. ----
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (req.method === 'PUT') {
      ...
      // Mises à jour ciblées : un seul champ à la fois est envoyé depuis
      // admin.html (updateField, addImage, etc.), donc on ne touche que ce
      // qui est réellement présent dans le corps de la requête.
