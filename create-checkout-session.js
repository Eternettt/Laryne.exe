...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Demandée par Stripe Checkout uniquement pour les commandes d'articles
    // physiques (panier, création perso) : inutile pour un acompte d'atelier.
    // Adapte cette liste de pays si tu livres ailleurs.
    const needsShippingAddress = !!(body.cart || body.customOrder);
    const shippingOptions = needsShippingAddress
